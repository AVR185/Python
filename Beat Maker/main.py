...
'''
hi_hat = mixer.Sound('Beat Maker\sounds\hi hat.wav')
snare = mixer.Sound('Beat Maker\sounds\snare.wav')
kick = mixer.Sound('Beat Maker\sounds\kick.wav')
crash = mixer.Sound('Beat Maker\sounds\crash.wav')
clap = mixer.Sound('Beat Maker\sounds\clap.wav')
tom = mixer.Sound("Beat Maker\sounds\\tom.wav")

screen = pygame.display.set_mode([WIDTH, HEIGHT])
pygame.display.set_caption('The Beat Maker')
label_font = pygame.font.Font('Beat Maker\Roboto-Bold.ttf', 32)
medium_font = pygame.font.Font('Beat Maker\Roboto-Bold.ttf', 24)
beat_changed = True
...
load_menu = False
saved_beats = []
file = open('Beat Maker\saved_beats.txt', 'r')
for line in file:
